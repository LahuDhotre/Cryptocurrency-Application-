...
import { GrTwitter, GrInstagram, GrGithub, GrFacebook } from 'react-icons/gr'
            ...
            <div className='grid md:grid-cols-2'>
                ...
                <div className='text-right'>
                    <div className='w-full flex justify-end'>
                        <div className='w-full md:w-[380px] py-4 relative'>
                            <div className='flex justify-center md:justify-end py-4 md:py-8 md:pb-4 mt-[-1rem]'>
                                <ThemeToggle />
                            </div>
